 ...
 */
final class Version20200602184803 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE v_order ADD state VARCHAR(255) NOT NULL, ADD new TINYINT(1) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE v_order DROP state, DROP new');
    }
}
